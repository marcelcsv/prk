...
import br.com.bb.uop.geadesp.prk.facade.AbstractFacade;
import br.com.bb.uop.geadesp.prk.facade.LazyEntityDataModel;
...
public abstract class AbstractController<T> implements Serializable {
    ...
    public void save(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/prkBundle").getString(itemClass.getSimpleName() + "Updated");
    ...
    public void saveNew(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/prkBundle").getString(itemClass.getSimpleName() + "Created");
    ...
    public void delete(ActionEvent event) {
        String msg = ResourceBundle.getBundle("/prkBundle").getString(itemClass.getSimpleName() + "Deleted");
    ...
    private void persist(PersistAction persistAction, String successMessage) {
        if (selected != null) {
            ...
            try {
                ...
                JsfUtil.addErrorMessage(ex, ResourceBundle.getBundle("/prkBundle").getString("PersistenceErrorOccured"));
            }
        }
    }
